...
public class SendFile {
    ...
    public static void sendFileMsg(File aimFile, SimpleDateFormat simpleDateFormat, ThreadPoolExecutor poolExecutor, FileMsgService fileMsgService, ListView<SendMsg> msgListView, Integer port) {
        if (aimFile.isFile()) {
            SendMsg sendMsg = new SendMsg();
            sendMsg.setType(1);
